...
class DecisionInput(BaseModel):
    ...
    variables: Optional[Dict[str, VariableDistribution]] = Field(
        None, description="Structured variables extracted from the decision"
    )
...
class StructuredDecision(BaseModel):
    ...
    raw_text: str
    meta: Dict[str, Any] = Field(default_factory=dict, description="Parser metadata and warnings")
